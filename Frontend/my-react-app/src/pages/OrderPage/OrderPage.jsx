...
const OrderPage = () => {
    ...
    return (
        ...
        <div style={{height: '100%', width: '1270px', margin: '0 auto'}}>
            <h3 style={{fontWeight: 'bold', fontSize: '30px', textAlign: 'center', paddingTop: '15px', marginTop: '10px'}}>Giỏ hàng</h3>
            ...
            <WrapperLeft>
                ...
                {order?.orderItems?.map((order) => {
                    ...
                    <img src={order?.image} style={{width: '77px', height: '79px', objectFit: 'cover'}} alt='image'/>
                    <div style={{
                        width: 260,
                        overflow: 'hidden',
