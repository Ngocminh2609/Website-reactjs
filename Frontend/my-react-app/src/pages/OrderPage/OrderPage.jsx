            ...
            <WrapperLeft>
                ...
                {Array.isArray(order?.orderItems) && order?.orderItems.map((item) => {
                    ...
                    <WrapperItemOrder key={item?.product}>
                        ...
                        <CustomCheckbox onChange={onChange} value={item?.product} checked={listChecked.includes(item?.product)}></CustomCheckbox>
                        <img src={item?.image} style={{ width: '77px', height: '79px', objectFit: 'cover' }} alt='image' />
                        <div style={{
                            width: 260,
                            overflow: 'hidden',
                        ...
                        <WrapperCountOrder>
                            <button style={{ border: 'none', background: 'transparent', cursor: 'pointer' }} onClick={() => handleChangeCount('decrease', item?.product, item?.amount === 1)}>
                            <MinusOutlined style={{ color: '#000', fontSize: '10px' }} />
                            </button>
                            <WrapperInputNumber defaultValue={item?.amount} value={item?.amount} size="small" min={1} max={item?.countInstock} />
                            <button style={{ border: 'none', background: 'transparent', cursor: 'pointer' }} onClick={() => handleChangeCount('increase', item?.product, item?.amount === item.countInstock, item?.amount === 1)}>
